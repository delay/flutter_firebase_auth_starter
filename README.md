...
## I have [remade](https://github.com/delay/flutter_starter) this project with [GetX](https://github.com/jonataslaw/getx). I find the code is simpler. This project makes use of Provider. The GetX version is [here](https://github.com/delay/flutter_starter). I will no longer maintain this code.
